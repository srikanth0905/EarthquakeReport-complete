...
public final class QueryUtils {
    ...
    public static ArrayList<Quake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                //Log.v("mag value in double",String.valueOf(mag));
                mag = magnitudeFormat(mag);
                //String magnitude = magnitudeFormat(mag);

                String location = properties.getString("place");
                String[] place = splitPlace(location);
    ...
    private static String[] splitPlace(String location) {
    ...
    private static double magnitudeFormat(double mag) {
        DecimalFormat format = new DecimalFormat("0.0");
        //Log.v("formatted mag Value",String.valueOf(Double.parseDouble(format.format(mag))));

        return Double.parseDouble(format.format(mag));
    }
